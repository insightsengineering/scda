...
R package with utility functions used by all other NEST packages.
...
1. Clone the repository
   ...
   1. Using PAT. Input in the Git Bash console, PowerShell or any Linux shell:
      ...
      ```
      $ git clone https://github.com/insightsengineering/utils.nest.git
...
2. Build and install
   ...
   ```
   $ Rscript -e 'install.packages("utils.nest_0.9.5.9000.tar.gz")'
